...
static const unsigned int barpadh = 20;  
static const unsigned int barheight = 0; 
...
static const char dmenufont[] =
    "SauceCodePro Nerd Font:size=10:antialias=true:autohint=true";
static const char col_gray1[] = "#2E2A44"; /* base */
static const char col_gray2[] = "#2a273f"; /* surface */
static const char col_gray3[] = "#5F6368"; /* subtle */
static const char col_gray4[] = "#ffffff"; /* text */
static const char col_cyan[] = "#0D3866";  /* pine */
...
static const char *applauncher[] =  {"app-launcher.sh", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray4, "-sb", col_cyan, "-sf", col_gray4, NULL};
static const char *systemcmd[] =    {"system.sh",       "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray4, "-sb", col_cyan, "-sf", col_gray4, NULL};
static const char *wificmd[] =      {"wifi.sh",         "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray4, "-sb", col_cyan, "-sf", col_gray4, NULL};
static const char *srccmd[] =       {"src-projects.sh", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray4, "-sb", col_cyan, "-sf", col_gray4, NULL};
